    ...
    return (
        <div className="flex flex-row justify-center">
            <div className="w-4/5 border border-[#E4E4E4] rounded-[16px] h-[60px] bg-[#FFFFFF] flex items-center ">
                <button className="border-none outline-none bg-inherit cursor-pointer ">
                    <Image src={"/icons/search-normal.svg"} alt="Search" width={24} height={24} className="" />
                </button>
                <input className="basis-9/10 outline-none border-none   text-[16px] font-vazir-normal leading-[25px] placeholder:text-[#E4E4E4]" placeholder="جستجو کالا" />
